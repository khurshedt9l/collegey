        ...
        <div class="col-lg-12">
            ...
            <div class="p-header shadowBox">
            	<div class="box clearfix">
                    ...
                    <div class="detail">
<!--                        <a class="red-editButton" id="updateprofile" href="#"><i></i>Update Profile</a>-->
                        <h3><?php echo ucwords(strtolower($user->fname ." ". $user->lname));?></h3>
                        <p><?php echo $form->field($model, 'description')->textarea(['class' =>'form-control minHeight' ,'placeholder' =>'Describe Yourself'])->label(false);?></p><br>
                        <p><?php echo $form->field($model, 'image')->fileInput(['class' => 'upload'])->label(false);?></p>
                    </div>
                </div>
            </div>                      
                        	...
                        	<div class="formElements">
                            	<div class="col-3 addmarginB30 clearfix">
                                	<div class="col col1">
                                    	...
                                    	<?php echo $form->field($user, 'fname')->textInput(['value' =>$user->fname ,'class' =>'form-control'])->label(false);?>
                                    </div>
                                    <div class="col col2">
                                    	<label>Last Name</label>
                                    	<?php echo $form->field($user, 'lname')->textInput(['value' =>$user->lname ,'class' =>'form-control'])->label(false);?>
                                    </div>
                                    <div class="col col3">
                                    <?php  
                                ...
                                <div class="col-3 clearfix">
                                	<div class="col col1">
                                    	<label>Gender</label>
                                    	<?php echo $form->field($model, 'gender')->dropDownList(['0'=>'Select' ,'M'=>'Male' ,'F'=>'Female'],['class' =>'singleSelectBox'])->label(false);?>
                                    </div>
                                    <div class="col col2">
                                    	<label>Mobile Number</label>
                                    	<?php echo $form->field($user, 'phone')->textInput(['value' =>$user->phone ,'class' =>'form-control'])->label(false);?>
                                    </div>                                    
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="support-form addmarginB30">
                    	<div class="padding30px">
                        	<div class="formElements">
                            	<div class="common">
                                	<label>Address</label>
                                    <?php echo $form->field($address, 'address')->textInput(['class'=>'form-control','placeholder'=>'Arress'])->label(false);?>
                                </div>
                            	<div class="col-3 addmarginB30 clearfix">
                                	<div class="col col1">
                                    	<label>Country</label>
                                    	<?php
                                            ...
                                            echo $form->field($address, 'country_id')->dropDownList($coutrylist,  ['prompt'=>'Select Country','class'=>'singleSelectBox','data-tags'=>true
                                ...
                                <div class="col-3 clearfix">
                                	<div class="col col1">
                                        ...
                                        <?= $form->field($address, 'landmark')->textInput(['class' =>'form-control' ,'placeholder' =>'Landmark'])->label(false);?>
                                        </div>
                                        <div class="col col2">
                                    	<label>Pin Code</label>
                                        <?= $form->field($address, 'pincode')->textInput(['class' =>'form-control numberonly' ,'placeholder' =>'Pincode'])->label(false);?>
                                        </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="support-form addmarginB30">
                    	<div class="padding30px">
                            ...
                            <p>Approximately how much per year of study will you, your family, and/or other sources of funding be able to provide to meet the cost of your education?</p>                            	
                                <div class="col-3 clearfix">
                                	<div class="col col1">
                                    	<?= $form->field($userpay, 'amount')->textInput(['class' =>'form-control numberonly' ,'placeholder' =>'Amount'])->label(false);?>
                                    </div>                                                                      
                                </div>
                            </div>
                        </div>
