...
<script src="http://localhost:1337/socket.io/socket.io.js"></script>
    ...
    document.getElementById("chatlog").innerHTML = ($("#chatlog").html()+'<li class="clearfix">'+
                            '<div class="c-img"><img src="<?php echo $profilepic ;?>"></div>'+
                            '<div class="c-chat">'+
...
socketio.emit('adduser', {username:'<?php echo \Yii::$app->user->identity->username;?>',userprofilepic:'<?php echo $profilepic;?>'});
<?php }?>
});
...
socketio.on('updatechat', function (allusers,allpic, data, jointime) {
    console.log(allpic);
    $('#usersActivity').empty();
    var i=1;
          $.each(allusers, function(index, value) {
          $('#usersActivity').append('<li id="'+value+'" class="clearfix"><div class="c-img"><img id="userpic_'+i+'" src="'+allpic[index]+'" /></div><div class="c-user"><h5>'+value+'</h5><span class="greenBg">'+data+'</span><span>'+jointime+'</span></div></li>');
          i++;});
      var j=1;
