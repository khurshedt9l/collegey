...
socketio.emit('adduser', {username:'<?php echo \Yii::$app->user->identity->username;?>',userprofilepic:'<?php echo $profilepic;?>',usertype:'<?php echo \Yii::$app->user->identity->username;?>'});
<?php }?>
});
...
socketio.on('updatechat', function (allusers, allpic, userstype, jointime) {
    ...
    var i=1;
          ...
          $('#usersActivity').append('<li id="'+value+'" class="clearfix"><div class="c-img"><img id="userpic_'+i+'" src="" /></div><div class="c-user"><h5>'+value+'</h5><span id="usertype_'+i+'" class="greenBg"></span><span>'+jointime+'</span></div></li>');
          i++;});
      var j=1;
