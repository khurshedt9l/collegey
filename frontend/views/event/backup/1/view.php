...
socketio.on('updatechat', function (allusers, data, jointime) {
    $('#usersActivity').empty();
          $.each(allusers, function(index, value) {
          $('#usersActivity').append('<li id="'+value+'" class="clearfix"><div class="c-img"><img src="images/user-5.jpg" /></div><div class="c-user"><h5>'+value+'</h5><span class="greenBg">'+data+'</span><span>'+jointime+'</span></div></li>');
          });});
