...
//    }
    ...
    {
        return [
            [['requires_new_password', 'login_attempts', 'login_time', 'create_time', 'update_time', 'status'], 'integer'],
          
            [['username'], 'string', 'max' => 45],
            [['password', 'salt', 'email', 'validation_key', 'session_id'], 'string', 'max' => 255],
            [['password_strategy'], 'string', 'max' => 50],
